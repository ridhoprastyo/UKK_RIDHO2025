...
@section('content')
  <div class="container mx-auto p-4">
    ...
    <form action="{{ route('TodayTask.store') }}"
      ...
      <div class="mb-4">
        ...
        <input type="text" id="base-input" name="note"
          class="block w-full p-5 block w-full p-2 text-black border border-black rounded-lg bg-white text-base">
      </div>
      ...
      <div class="mb-4">
        ...
        <input type="date" id="date-input" name="date"
          class="block w-full p-2 block w-full p-5 block w-full p-2 text-black border border-black rounded-lg bg-white text-base"
          required>
      </div>

      <div class="mb-4">
        <label for="priority" class="block mb-2 text-black font-medium text-sm">Priority:</label>
        <select id="priority"
          class="block w-full p-2 block w-full p-5 block w-full p-2 text-black border border-black rounded-lg bg-white text-base"
